...
class TaichungPage extends StatefulWidget{
  const TaichungPage({Key? key}) : super(key: key);

  @override
  _TaichungPage createState() =>_TaichungPage();
}
class _TaichungPage extends State<TaichungPage>{
  String selectedDate='';
  String avgtmp='';
  String hitmp='';
  String lowtmp='';
  ...
  Future<Map<String, dynamic>> post()async{
    String url="http://140.120.183.226/xampp/test/aiotrequestTaichung.php";
