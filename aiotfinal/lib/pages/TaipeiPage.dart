...
class TaipeiPage extends StatefulWidget{
  const TaipeiPage({Key? key}) : super(key: key);

  @override
  _TaipeiPage createState() =>_TaipeiPage();
}
class _TaipeiPage extends State<TaipeiPage>{
  String selectedDate='';
  String avgtmp='';
  String hitmp='';
  String lowtmp='';
